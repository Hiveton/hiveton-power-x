...
static int g_qc_calls;
static int g_cc_calls;
static int g_cable_calls;
...
static void test_cable_page_receives_vbus_measurement(void)
{
    ui_model_state_t state;
    measure_snapshot_t measure = {
        .voltage_avg_mv = 5000,
...
int main(void)
{
    ...
    test_cable_page_receives_vbus_measurement();
