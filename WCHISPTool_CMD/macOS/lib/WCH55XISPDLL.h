...
typedef struct _NET_MODULE_INFOMATION
{
    CHAR name[64];                    
    UCHAR IP[4];                  
    UCHAR MAC[6];                
    UCHAR verion;                    
}NetModules,* pNetModules;
...
typedef struct _DEVICEHW_CONFIG
{
    ...
    UCHAR  bAuxDevType;                   
    UCHAR  bIndex;                        
    UCHAR  bDevHardwareVer;                
    UCHAR  bDevSoftwareVer;                
    UCHAR  szModulename[21];            
    UCHAR  bDevMAC[ 6 ];               
    UCHAR  bDevIP[ 4 ];                    
    UCHAR  bDevGWIP[ 4 ];                
    UCHAR  bDevIPMask[ 4 ];                
...
typedef struct _DEVICEPORT_CONFIG
{
    ...
    UCHAR  bStopBits;                
    UCHAR  bParity;                    
    UCHAR  bPHYChangeHandle;        
    ULONG  dRxPktlength;            
    ULONG  dRxPktTimeout;            
    UCHAR  bReConnectCnt;           
    UCHAR  bResetCtrl;               
    UCHAR  bDNSFlag;               
    UCHAR  szDomainname[20];        
    UCHAR  bDNSHostIP[4];            
    USHORT wDNSHostPort;            
    UCHAR  breserved[8];            
...
UINT WCH55x_EnumCH9121(PCHAR mLocalIP,          
                       USHORT wLocalPort,          
                       PUCHAR mLocalMAC,          
                       USHORT wDevCfgPort,      
                       pNetModules mNetModules,
                       USHORT uMaxEnumCnt);      


INT WCH55x_SetCH9121BootMode(PCHAR IPAddress,        
                             USHORT wLocalPort,                  
                             PUCHAR mLocalMAC,                   
                             PUCHAR mDevCfgMAC,                  
                             USHORT wDevCfgPort,                 
                             NetDeviceConfigS *pNetDeviceInfo);   


INT WCH55x_GetCH9121NetInfo(PCHAR IPAddress,            
                            USHORT wLocalPort,                  
                            PUCHAR mLocalMAC,                   
                            PUCHAR mDevCfgMAC,                  
                            USHORT wDevCfgPort,                 
...
INT WCH55x_SetCH9121NetInfo(PCHAR IPAddress,             
                            USHORT wLocalPort,                  
                            PUCHAR mLocalMAC,                   
                            PUCHAR mDevCfgMAC,                  
                            USHORT wDevCfgPort,                    
