...
require_symbol "app_trigger_control_apply_auto"
require_symbol "app_trigger_control_apply_pd"
require_symbol "app_trigger_control_apply_qc"
...
require_symbol "bsp_dpdm_apply_qc2_voltage_mv"
require_symbol "bsp_dpdm_apply_qc3_pulse"
...
require_symbol "service_pd_set_preferred_voltage_mv"
...
require_symbol "service_legacy_charge_request_voltage_mv"
...
require_symbol "ui_renderer_draw_trigger_page"
require_symbol "ui_renderer_draw_pdo_page"
require_symbol "ui_renderer_draw_qc_page"
require_symbol "ui_renderer_draw_cc_page"
require_symbol "ui_renderer_draw_cable_page"
